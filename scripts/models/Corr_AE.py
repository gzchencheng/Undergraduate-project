...
class Corr_AE():
    def __init__(self, text_size: object, img_size: object, feature_size=256) -> object:
        ...
        self.img_model = AutoEncoder.AutoEncoder(input_size=img_size,feature_size=feature_size)
    ...
    def save(self):
        ...
        for loss in self.loss:
            ...
            f.write('\n')
    #保存模型及训练损失
    def load(self,path = 'trained_models/Corr_AE/'):
        try:
    ...
    def get_similarity(self,text,img):
        ...
        img_encode,img_decode = self.img_model(img)
    ...
    def get_samemodal_similarity(self,a,b,type):
        ...
        if type == 'text':
            ...
            a_encode, a_decode = self.img_model(a)
            b_encode, b_decode = self.img_model(b)
